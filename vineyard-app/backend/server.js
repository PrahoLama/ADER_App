...
app.post('/api/parse-dji-log', upload.single('logFile'), async (req, res) => {
  console.log('\n' + '='.repeat(60));
  console.log('🚁 DJI LOG PARSING REQUEST - USING dji-log BINARY');
  ...
  try {
    ...
    console.log(`📋 CSV Headers (${header.length} columns):`, header.slice(0, 10));
    ...
    console.log('🔍 Key column indices:', keyColumns);
    ...
    console.log(`✅ Parsed ${parsedData.length} valid GPS records`);
